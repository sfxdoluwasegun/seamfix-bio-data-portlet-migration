...
public class I18nMessageConstants {
    ...
    public static final String RESOURCE_BUNDLE_FILENAME_SUFFIX = ".properties";
    public static final String RESOURCE_DEFAULT_PATH = "/language-bundles";
}